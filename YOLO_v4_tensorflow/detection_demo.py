...
# video_path   = "./IMAGES/SJtrafficmorning.mp4"

video_path   = "./aditya_sahu_input.mp4"
...
detect_video(yolo_model, video_path, "", input_size=YOLO_INPUT_SIZE, show=True, rectangle_colors=(255,0,0))
